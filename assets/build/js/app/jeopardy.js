var vmJeopardy = new Vue({
    ...
    created: function() {
        $.getJSON('includes/jeopardy/data.json')
            .done(function(data) {
                // console.log(data);
                vmJeopardy.results = data;
        })
    },
    mounted: function() {
        this.$watch('track', function () {
            this.$refs.jeopardyPlayer.load(); // reloads audio player            
            ...
            if (!is_safari) { // if not Safari browser
                ...
                this.$refs.jeopardyPlayer.play(); // play
            }
        });
    },
    filters: {
