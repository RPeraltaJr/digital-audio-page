var vmLibertyMutual = new Vue({
    ...
    created: function() {
        $.getJSON('includes/liberty-mutual/data.json')
            .done(function(data) {
                // console.log(data);
                vmLibertyMutual.results = data;
        })
    },
    mounted: function() {
        this.$watch('track', function () {
            this.$refs.libertyMutualPlayer.load(); // reloads audio player            
            ...
            if (!is_safari) { // if not Safari browser
                ...
                this.$refs.libertyMutualPlayer.play(); // play
            }
        });
    },
    filters: {
