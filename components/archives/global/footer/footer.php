  ...
  <script src="assets/build/js/app/tide.js?v=<?php echo $version; ?>"></script>
  <script src="assets/build/js/app/pampers.js?v=<?php echo $version; ?>"></script>
  <script src="assets/build/js/app/pepsi.js?v=<?php echo $version; ?>"></script>
